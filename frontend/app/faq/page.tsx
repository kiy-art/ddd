...
const FAQS = [
  {
    ...
    a: "各商品の過去30日間の価格データをもとに、平均価格との差、直近の値動き、これまでの最安値との距離などから機械的なルールでAI BUY SIGNALスコア（1〜99）を算出しています。将来の値動きを予測するものではなく、あくまで過去の価格水準と比べて今が割安かどうかの参考情報です。",
  },
  {
    q: "最安値を保証していますか？",
...
export const metadata: Metadata = {
  title: "よくある質問",
  description: "PAR.のBUY SIGNAL判定の仕組み、価格データの取得元、アフィリエイトについてなど、よくある質問にお答えします。",
};
