    ...
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
      <article className="flex flex-col gap-10 text-sm leading-relaxed text-foreground/70">
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>
            当サイトは、楽天アフィリエイトプログラムに参加しています。商品ページ内の「楽天市場で価格を見る」等の
            リンクには、アフィリエイトリンクが含まれます。リンクを経由して商品を購入された場合、
            当サイト運営者が楽天市場より紹介料を受け取ることがあります。紹介料の有無は、掲載価格や表示される
            情報の中立性には一切影響しません。Amazonアソシエイト等、他のアフィリエイトプログラムへの
            参加は今後検討中です。
          </p>
        </section>
